window.catalog = [{
    ...
    colors: ['Black', 'White'],
    sizes: ['UK 18'],
    thumbnail: 'img/Boyfriend_T-Shirt_with_Bohemian_Print.jpg', // replace with image extracted from item layout
    preview: ['img/Boyfriend_T-Shirt_with_Bohemian_Print_1.jpg', 'img/Boyfriend_T-Shirt_with_Bohemian_Print_2.jpg', 'img/Boyfriend_T-Shirt_with_Bohemian_Print_3.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Black'],
    sizes: ['UK 2','UK 18L'],
    thumbnail: 'img/Boyfriend_T-Shirt_with_Paris_Print.jpg', // replace with image extracted from item layout
    preview: ['img/Boyfriend_T-Shirt_with_Paris_Print_1.jpg', 'img/Boyfriend_T-Shirt_with_Paris_Print_2.jpg', 'img/Boyfriend_T-Shirt_with_Paris_Print_3.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18','UK 20'],
    thumbnail: 'img/Straight_Leg_Jeans.jpg', // replace with image extracted from item layout
    preview: ['img/Straight_Leg_Jeans_1.jpg', 'img/Straight_Leg_Jeans_2.jpg', 'img/Straight_Leg_Jeans_3.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: 'img/Levi’s_Jeans_for_women.jpg', // replace with image extracted from item layout
    preview: ['img/preview.jpg', 'img/preview.jpg', 'img/preview.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    thumbnail: 'img/Dark_classic_fit_suit.jpg', // replace with image extracted from item layout
    preview: ['img/Dark_classic_fit_suit_1.jpg', 'img/Dark_classic_fit_suit_2.jpg', 'img/Dark_classic_fit_suit_3.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Green'],
    sizes: ['UK 19'],
    thumbnail: 'img/Neck_Knitted_Jumper.jpg', // replace with image extracted from item layout
    preview: ['img/Neck_Knitted_Jumper_1.jpg', 'img/Neck_Knitted_Jumper_2.jpg', 'img/Neck_Knitted_Jumper_3.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 17'],
    thumbnail: 'img/Only_Skinny_Jeans.jpg', // replace with image extracted from item layout
    preview: ['img/Only_Skinny_Jeans_1.jpg', 'img/Only_Skinny_Jeans_2.jpg', 'img/Only_Skinny_Jeans_3.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Green'],
    sizes: ['UK 22', 'UK 22S'],
    thumbnail: 'img/Turtle_Neck_Jumper_in_Rib.jpg', // replace with image extracted from item layout
    preview: ['img/preview.jpg', 'img/preview.jpg', 'img/preview.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Dark Blue'],
    sizes: ['UK 19'],
    thumbnail: 'img/Only_Busted_Knee_Jean.jpg', // replace with image extracted from item layout
    preview: ['img/preview.jpg', 'img/preview.jpg', 'img/preview.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Gray'],
    sizes: ['UK 18'],
    thumbnail: 'img/Colour_Block.jpg', // replace with image extracted from item layout
    preview: ['img/preview.jpg', 'img/preview.jpg', 'img/preview.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 18', 'UK 19'],
    thumbnail: 'img/Oversized_Cardigan.jpg', // replace with image extracted from item layout
    preview: ['img/preview.jpg', 'img/preview.jpg', 'img/preview.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: 'img/Paul_&_Joe_Sister_Jumper_with_Neon_Trims.jpg', // replace with image extracted from item layout
    preview: ['img/preview.jpg', 'img/preview.jpg', 'img/preview.jpg'] // replace with paths to images extracted from item layout
}];
